...
Dagli FP e'possibile ottenere le LOC utilizzando un'apposita tabella, che contiene, dato il linguaggio scelto, le linee di codice per function point.
...
Gli FP ha anche l'ulteriore vantaggio di poter essere calcolato in fase preventiva e puo'essere ricalcolato utilizzando il *backfiring*.

**Calcolo degli FP**: il calcolo degli FP avviene attraverso il *metodo standard IFPUG*. Avviene attraverso 7 fasi:
